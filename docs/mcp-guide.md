...
Claude handles downloading the marketplace repository. A manual clone is not required. See [Claude installation instructions](https://code.claude.com/docs/en/discover-plugins#add-from-other-git-hosts).
